...
iter = 2048
store_path = '/mmdetection3d/saved_points/saved_pp_flow_epoch_4_'+ str(iter)
...
class HardVFE(nn.Module):
    ...
    def forward(self,
        ...
        # ========================== Save point clouds =========================
            ...
            features_pred_flow1_c = features_pred_flow1.to('cpu')
            ...
            pts_dict = {'first_sample_point_coors': first_sample_point_coors_c , 'predicted_flow': features_pred_flow1_c}
            local_time = time.localtime()
            file_name = '{}.npy'.format(str(img_metas[0]['pts_filename'][37:43]))
